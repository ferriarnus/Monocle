...
import com.ferri.arnus.monocle.embeddiumCompatibility.impl.IrisChunkShaderBindingPoints;
...
public class IrisChunkProgramOverrides {
	...
	private EmbeddiumTerrainPipeline getEmbeddiumTerrainPipeline() {
		...
		if (worldRenderingPipeline != null) {
			return ((WorldRenderingPipelineExtension) worldRenderingPipeline).getEmbeddiumTerrainPipeline();
		} else {
			return null;
		}
	}
	...
	public GlProgram<IrisChunkShaderInterface> getProgramOverride(TerrainRenderPass pass, ChunkVertexType vertexType) {
		...
		if (worldRenderingPipeline != null) {
			EmbeddiumTerrainPipeline = ((WorldRenderingPipelineExtension) worldRenderingPipeline).getEmbeddiumTerrainPipeline();
		}
