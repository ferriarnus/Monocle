...
public class MixinBlackboardBlockTileRenderer {
    ...
    @WrapOperation(method = "render(Lnet/mehvahdjukaar/supplementaries/common/block/tiles/BlackboardBlockTile;FLcom/mojang/blaze3d/vertex/PoseStack;Lnet/minecraft/client/renderer/MultiBufferSource;II)V", at = @At(value = "FIELD", target = "Lnet/mehvahdjukaar/supplementaries/client/renderers/NoiseRenderType;STATIC_NOISE:Ljava/util/function/Function;"))
